...
//   if (!productData || !selectedColor || price === 0) return;
...
//   //   return Object.entries(productData.priceConfiguration).map(([key, value]: [string, { availableOptions: Record<string, number> }]) => ({
//   //     name: key,
